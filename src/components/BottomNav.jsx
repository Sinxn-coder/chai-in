...
const BottomNav = ({ lang = 'en' }) => {
  ...
  // Hide BottomNav when ClubLeaderboard is open, but show Add Spot button on Add Spot page
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        left: 0,
        right: 0,
        height: isAddSpotPage ? 80 : 70, // Slightly taller for Add Spot page
        zIndex: 9999, // Highest z-index to stay on top
        pointerEvents: 'none',
      }}
    >
      {isAddSpotPage ? (
        // Show only Add Spot button on Add Spot page
        <div
          style={{
            position: 'absolute',
            top: '50%',
