...
export default function ReviewsPage() {
  const [reviews] = useState([
    ...
    },
    {
      ...
      rating: 5,
      date: '2024-01-02',
      comment: 'Absolutely loved it! The atmosphere was perfect and staff was incredibly helpful.',
      spotName: 'Sunset Lounge',
      spotCategory: 'Bar',
      helpful: 22,
      status: 'approved'
    },
    {
      ...
      rating: 3,
      date: '2024-01-01',
      comment: 'Average experience. Nothing special but not bad either. Service could be improved.',
      spotName: 'Central Park Cafe',
      spotCategory: 'Coffee Shop',
      helpful: 5,
      status: 'pending'
    },
    {
      ...
      rating: 5,
      date: '2023-12-31',
      comment: 'Perfect end to the year! Amazing food, great service, and wonderful atmosphere.',
      spotName: 'New Year Restaurant',
      spotCategory: 'Restaurant',
      helpful: 31,
      status: 'approved'
    },
    {
      ...
      rating: 4,
      date: '2023-12-30',
      comment: 'Very good experience overall. The place was clean and staff was professional.',
      spotName: 'Downtown Hotel',
      spotCategory: 'Hotel',
      helpful: 12,
      status: 'approved'
    },
    {
      ...
      rating: 5,
      date: '2023-12-29',
      comment: 'Outstanding service and quality! This place exceeded all my expectations.',
      spotName: 'Luxury Spa',
      spotCategory: 'Spa',
      helpful: 28,
      status: 'approved'
    },
    {
      ...
      rating: 4,
      date: '2023-12-28',
      comment: 'Great value for money. The portions were generous and taste was excellent.',
      spotName: 'Family Diner',
      spotCategory: 'Restaurant',
      helpful: 15,
      status: 'approved'
    },
    {
      ...
      rating: 5,
      date: '2023-12-27',
      comment: 'Absolutely fantastic! Best dining experience I\'ve had in months.',
      spotName: 'Gourmet Kitchen',
      spotCategory: 'Restaurant',
      helpful: 35,
      status: 'approved'
    },
    {
      ...
      rating: 3,
      date: '2023-12-26',
      comment: 'Decent place but could use some improvements in service speed.',
      spotName: 'Quick Bites',
      spotCategory: 'Fast Food',
      helpful: 7,
      status: 'pending'
    },
    {
      ...
      rating: 4,
      date: '2023-12-25',
      comment: 'Nice Christmas dinner! The atmosphere was festive and food was delicious.',
      spotName: 'Holiday Inn',
      spotCategory: 'Hotel',
      helpful: 19,
      status: 'approved'
    },
    {
      ...
      rating: 5,
      date: '2023-12-24',
      comment: 'Perfect Christmas Eve dinner! The special menu was outstanding.',
      spotName: 'Festive Restaurant',
      spotCategory: 'Restaurant',
      helpful: 26,
      status: 'approved'
    },
    {
      ...
      rating: 4,
      date: '2023-12-23',
      comment: 'Very pleasant experience. Good food, nice ambiance, and reasonable prices.',
      spotName: 'Corner Cafe',
      spotCategory: 'Coffee Shop',
      helpful: 11,
      status: 'approved'
    },
    {
      ...
      rating: 5,
      date: '2023-12-22',
      comment: 'Exceptional service and quality! This place is a hidden gem.',
      spotName: 'Secret Garden',
      spotCategory: 'Restaurant',
      helpful: 33,
      status: 'approved'
    },
    {
      ...
      rating: 4,
      date: '2023-12-21',
      comment: 'Great find! The food was delicious and the service was attentive.',
      spotName: 'Asian Fusion',
      spotCategory: 'Restaurant',
      helpful: 17,
      status: 'approved'
    }
